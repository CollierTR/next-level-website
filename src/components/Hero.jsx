	...
	return (
		<div className="flex justify-center place-items-center relative overflow-hidden min-h-screen  before:top-0 before:start-1/2 ">
			...
			<motion.div
				...
				className="textOutline max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-20"
			>
				{/* Title */}
				<div className="mt-5 max-w-4xl text-center mx-auto">
					<h1 className="block font-bold text-3xl text-balance md:text-5xl lg:text-6xl ">
