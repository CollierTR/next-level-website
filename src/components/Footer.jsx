...
export default function Footer() {
	return (
		<footer>
			<div className="w-full py-8 flex flex-col justify-center gap-8  place-items-center border-t-2 border-t-primary text-white">
				<div className="flex w-4/5 px-6 text-4xl  justify-center place-items-center">
					<div className="flex flex-col md:flex-row  gap-6 justify-between w-full">
						...
						<img
							...
							alt="Next Level Logo"
							className="h-auto w-50 md:w-40 object-contain md:mx-0 mx-auto"
						/>
