...
export default function ReviewCard({
	...
	return (
		<div className="text-start p-6 flex flex-col text-lg md:text-xl border-3 drop-shadow-2xl border-black justify-center place-items-start gap-4 text-dark bg-white rounded-xl w-10/12 sm:w-1/2 lg:w-[28%]">
