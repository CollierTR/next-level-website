                  ...
                  <ul className="block lg:flex">
                    <li className="relative">
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-2 py-2 text-black font-medium  hover:text-dark lg:ml-12 lg:inline-flex lg:w-auto lg:justify-center  dark:hover:text-red-900"
                      >
                        Resources
                        <span
                      ...
                      >
                        <div className="rounded-t-xl bg-white p-2 lg:p-8 dark:bg-dark">
                          <div className="mb-8">
                            <h4 className="mb-1 text-black font-medium  dark:text-blue-700">
                              Resources
                            </h4>
